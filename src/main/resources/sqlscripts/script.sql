...
VALUES ('Iphone 12 pro max',28500.89,'Apple'),
       ('Macbook air m1 2020',29580.23,'Apple'),
       ('Samsung Note 10',18700.60,'Samsung'),
       ('ASUS TUF Gaming F15',35890.50,'Gaming Laptop'),
       ('Corsair N19',7800.78,'PC Peripheral'),
       ('Speed CUB 3x3',2345.70,'BrainPuzzle'),
       ('Acoustic Guitar Aria',5600.89,'Musicals Instrument'),
       ('PC Gaming Armor',45000.67,'PC'),
       ('Apple Watch S4',7600.90,'Apple'),
       ('ASUS ZENBOOK',18900.89,'ASUS'),
